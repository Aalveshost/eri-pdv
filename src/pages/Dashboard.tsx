      ...
      <div className="flex-1 grid grid-cols-2 gap-8 overflow-hidden min-h-0">
        <div className="flex flex-col gap-3 overflow-hidden">
          ...
          <div className="flex items-center gap-2 shrink-0 pr-2">
            <span className="text-xs text-white/40 font-bold uppercase tracking-widest">De</span>
            ...
            <span className="text-xs text-white/40 font-bold uppercase tracking-widest">Até</span>
            ...
            <button ref={verProdBtnRef} tabIndex={-1} onClick={() => setShowPopupProd(true)} onFocus={() => setNavZone("ver-prod")} className={cn("ml-auto text-xs font-bold uppercase tracking-widest flex items-center gap-1 transition-all outline-none rounded-md whitespace-nowrap", navZone === "ver-prod" ? "text-luxury-orange ring-1 ring-luxury-orange/50 px-2 py-0.5 bg-luxury-orange/5" : "text-white/40 hover:text-luxury-orange")}>Ver completo <ChevronRight size={12} /></button>
          </div>
        ...
        <div className="flex flex-col gap-3 overflow-hidden">
          ...
          <div className="flex items-center gap-2 shrink-0 pr-2">
            ...
            <button ref={verCompletoBtnRef} tabIndex={-1} onClick={() => setShowPopupVendidos(true)} onFocus={() => setNavZone("ver-completo")} className={cn("ml-auto text-xs font-bold uppercase tracking-widest flex items-center gap-1 transition-all outline-none rounded-md whitespace-nowrap", navZone === "ver-completo" ? "text-luxury-orange ring-1 ring-luxury-orange/50 px-2 py-0.5 bg-luxury-orange/5" : "text-white/40 hover:text-luxury-orange")}>Ver completo <ChevronRight size={12} /></button>
          </div>
