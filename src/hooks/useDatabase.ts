      ...
      try {
        ...
        initPromise = (async () => {
          ...
          const migrations = [
            ...
            "ALTER TABLE configuracoes ADD COLUMN endereco_loja TEXT",
            "ALTER TABLE configuracoes ADD COLUMN celular_loja TEXT",
            "ALTER TABLE configuracoes ADD COLUMN instagram_loja TEXT",
